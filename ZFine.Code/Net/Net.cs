    ...
    public class Net
    {
        ...
        public static string Browser
        {
            get
            {
                if (HttpContext.Current == null)
                    return string.Empty;
                var browser = HttpContext.Current.Request.Headers["User-Agent"].ToString();//HttpContext.Current.Request.Browser;
                return browser;//string.Format("{0} {1}", browser.Browser, browser.Version);
            }
        }
        #endregion
    }
