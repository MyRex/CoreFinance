...
namespace ZFine.Code
{
    public class FileHelper
    {
        ...
        public static void CreateDir(string dir)
        {
            ...
            if (!Directory.Exists(HttpContext.Current.Request.PathBase + "\\" + dir))
                Directory.CreateDirectory(HttpContext.Current.Request.PathBase + "\\" + dir);
        }
        #endregion
        ...
        public static void DeleteDir(string dir)
        {
            if (dir.Length == 0) return;
            if (Directory.Exists(HttpContext.Current.Request.PathBase + "\\" + dir))
                Directory.Delete(HttpContext.Current.Request.PathBase + "\\" + dir);
        }
        #endregion
        ...
        {
            if (File.Exists(HttpContext.Current.Request.PathBase + file))
            {
                File.Delete(HttpContext.Current.Request.PathBase + file);
            }
        }
        #endregion
        ...
        public static void CreateFile(string dir, string pagestr)
        {
            ...
            StreamWriter sw = new StreamWriter(HttpContext.Current.Request.PathBase + "\\" + dir, false, Encoding.GetEncoding("GB2312"));
            sw.Write(pagestr);
            sw.Close();
        }
        /// <summary>
        ...
        public static void MoveFile(string dir1, string dir2)
        {
            dir1 = dir1.Replace("/", "\\");
            dir2 = dir2.Replace("/", "\\");
            if (File.Exists(HttpContext.Current.Request.PathBase + "\\" + dir1))
                File.Move(HttpContext.Current.Request.PathBase + "\\" + dir1, HttpContext.Current.Request.PathBase + "\\" + dir2);
        }
        #endregion
        ...
        public static void CopyFile(string dir1, string dir2)
        {
            ...
            if (File.Exists(HttpContext.Current.Request.PathBase + "\\" + dir1))
            {
                File.Copy(HttpContext.Current.Request.PathBase + "\\" + dir1, HttpContext.Current.Request.PathBase + "\\" + dir2, true);
            }
        }
        #endregion
