    ...
    public class WebHelper
    {
        ...
        public static string ResolveUrl(string relativeUrl)
        {
            ...
            if (relativeUrl.Contains("://"))
                return relativeUrl;
            return new Uri(relativeUrl).AbsolutePath;
        }
        ...
        public static void WriteSession<T>(string key, string value)
        {
            if (key.IsEmpty())
                return;
            HttpContext.Current.Session.Set(key, Encoding.Default.GetBytes(value));
        }
        ...
        public static string GetSession(string key)
        {
            if (key.IsEmpty())
                return string.Empty;
            return HttpContext.Current.Session.GetString(key) as string;
        }
        /// <summary>
        /// 删除指定Session
        /// </summary>
        ...
        public static void WriteCookie(string strName, string strValue, int expires)
        {
            ...
            co.Expires = DateTime.Now.AddMinutes(expires);
            if (HttpContext.Current.Request.Cookies.ContainsKey(strName))
            {
                HttpContext.Current.Response.Cookies.Delete(strName);
        ...
        {
            //Cookie objCookie = new Cookie(CookiesName.Trim(),"");
